...
print(colored(f.renderText('Welcome to my TUI'), 'green'))

while True:
  print("\n\n")
  print(Fore.YELLOW+ f'Press 1 To run a linux command{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 2 To configure the web server{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 3 To create a New User{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 4 To create Volume Group{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 5 To create LVM{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 6 To make your partition permanent{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 7 To create a Crontab{Style.RESET_ALL}') 
  print(Fore.YELLOW+ f'Press 8 To format a disk{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 9 To configure Docker server{Style.RESET_ALL}')
  print(Fore.YELLOW+ f'Press 10 To Exit the program{Style.RESET_ALL}')
